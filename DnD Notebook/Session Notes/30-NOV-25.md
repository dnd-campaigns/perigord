...
- Refer to [28-SEP-25](28-SEP-25.md) Notes<br>
- In the Bone Zone
- Exploring Temple
- Went into the compass door to the left
- Spike wall fight
- Went through pool room
- Went into the priest room
- Wnet into the dragon room
- Heal Slaps: 16 left
...
- There is a box 
![](../../Images/Maps/BattleMaps/bone-zone/Dragon-stair1-room.png)
...
##### Room w/Dead Skeleton
- Skeleton that is not moving 
- Water that is seeping into the room
- Above hallway; stairs at bottom

![](../../Images/Maps/BattleMaps/bone-zone/skeleton-2-room.png)

- Skeleton Search
  - Wet Stone
  - Knife 
  - Taurus takes the wet stone
- Helra checks to see how they died
  - Fails heal check
    - Thinks they died gracefully of old age


##### Room Above
- Door is magical 
- Alabaster checking what its magical of
  - Conjuration magick / doorway
  - Level 6+
  - Thinks its a portal 
- Hallamir toses a rock and it disappears
- Hallamir takes a bone from the skeleton and passes it through but still holding it. It just disapears at a certain point.
- Decision to have everyone walk through it together
  - Helra activates shield ring

##### Portal Room 1
- Leads to a hallway to a doorway 
- Doorway is also a portal
  - South Portal 
  - Bone and stone is right there
  - Maybe the same area we came from
- There is a hallway above that leads to two other locations
  - Left is open
  - Right has a bunch of rocks / blocked
- Door there is also a portal 
  - No evil around
  - Green goo and such inside
  - Bones in the goo  
  - Top area drops off to nothing

> [!Note]
> Portals don't neccessary need to lead to the same location both ways. 
> Can be different locations depending on the direction

- Decision -> we go back through the south portal to verify it will lead back to the same location
  - It does not!
  - New location / very long -> north hallway leading to a room area. 

##### Portal Room 2
_From Portal Room 1 -> South portal_
- Hallamir hears things
  - There is something in the walls

![](../../Images/Maps/BattleMaps/bone-zone/portal-room-2.png.png)

-  Door in the top right is stuck 
  - Not a portal
  - Maybe blocked from the other side for that door
- Helra checks around for any secret doors
  - There isn't any
- In the main area, Alabaster opens the door to the right in the hallway
  - Opens to a spider area
  - There is a portal

##### Spider Room Portal
_From Portal Room 2 -> Right portal in the spider room area_
- Outputs to the top room area from Skeleton room 2 
  - Stone Golem is present
  - Initiative time
...
- Taurus goes first
  ...
  - Hits
- Hallamirs Turn
  - Throws the rainbow weapon
  - Swing and a miss
  - No damage
- Helra's Turn
  - Leeve chukes an ice knife
    - does nothing
  - Helra misses
- Golem moves / atttack of opportunity 
  - Helra hits
  - Helra and Hallamir is slowed
    - (-1 to reflexs / ACs / one move or attack action each turn) 
  - Attacks Taurus
    - Hits / 14 damage  -3 (DR)
- Alabaster's Turn
  - Cannot use stone shape
  - Stone golums are immune to magick for the most part
  - Transmute stone to mud and flesh would work though
  - Greases the stone golem -> successful
  - Saves grease for later (cireclet)
  - Harrim's turn
    - Taking a swing
    - golem is prone
    - Doesn't do any damage
- Taurus does the final blow

##### Spider Room Portal (cont)
_From Portal Room 2 -> Right portal in the spider room area_
- Stone golem is dealt with
- three skeletons in the room
- Circle with the star


> [!Note]
> Helra / Leeve heal notes
> Leeve uses 12 focus for Cure Critical on Hallamir
> Helra uses all of belt of healing on Taurus -> 22
> Helra Caster Level -> Level -4 = 9
> Uses Bead of Healing -> 24
> ONLY  16 heal slaps left for Helras healing (can do some spells unless taken for other things)
> Leeve at Focus 9 
...
### Experience Received
**Previous Total:** 83,841 _(Updated with Discord version)_
**Adjustments:** 488 EX
**Total:** 84,329 EX
